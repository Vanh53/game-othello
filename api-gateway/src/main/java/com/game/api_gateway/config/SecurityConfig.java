...
public class SecurityConfig {
    ...
    public SecurityConfig(GatewayAuthenticationEntryPoint gatewayAuthenticationEntryPoint) {
        this.gatewayAuthenticationEntryPoint = gatewayAuthenticationEntryPoint;
    }
